...
### 2. Get Your Workspace Key & Create a Client

In the dashboard, go to **Settings → Workspace** and generate a workspace API key. Then go to **Clients** and create a new client. You'll need:
- **Workspace Key**: Authenticates your app to your workspace (from Settings → Workspace)
